...
For reference on Beta-Growth Function see Yin et al. 2003 (https://doi.org/10.1093/aob/mcg029).
...
3. SSricker (Ricker population growth)

See: https://en.wikipedia.org/wiki/Ricker_model

4. SSprofd (Profile of protein distribution)

See: Johnson et al. (2010) doi:10.1093/aob/mcq183

5. SSlinp (linear plus plateau)

6. SSquadp (quadratic-plateau)

7. SSblin (bilinear)

8. SSexpf (exponential function)

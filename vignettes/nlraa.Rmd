...
12. SSexpfp (exponential-plateau)
13. SSpexpf (plateau-exponential)
14. SSbgrp (Beta-Growth Reparameterized)
15. SSbg4rp (Beta-Growth with four parameters Reparameterized)
...
The \code{SSbgrp} function is a reparameterized version of \code{SSbgf}. The original \code{SSbgf} does not enforce the constraint that \code{t.m < t.e} and this makes it numerically unstable for routine use. To recover the original parameters from \code{SSbgrp}, take the exponential of \code{lt.e}, so \code{t.e = exp(lt.e)} and likewise \code{t.m = exp(lt.e) - exp(ldt)}. There is a similar function for the four parameter Beta growth \code{SSbg4rp}.
...
These are the available datasets in the package:
